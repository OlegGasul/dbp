...
/**
 * Data Transfer Object representing {@link ConicalCansEntity}
 */
public class ConicalCans extends Container {

    @NotEmpty(message = "{err.msg.conical.cans.uncode.required}")
    private String unCode;

    private Double overflowVolume;

    @NotNull(message = "{err.msg.conical.cans.total.weight.required}")
    ...
    @NotNull(message = "{err.msg.conical.cans.container.material.required}")
    ...
    @NotNull(message = "{err.msg.conical.cans.hole.required}")
    ...
    public void setDiameterLid(Double diameterLid) {
    ...
    public void setDiameterLidMin(Double diameterLidMin) {
    ...
    public void setDiameterLidMax(Double diameterLidMax) {
