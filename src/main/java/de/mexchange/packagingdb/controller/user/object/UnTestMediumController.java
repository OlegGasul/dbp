 ...
 */
@Controller
@RequestMapping("/untestmedium")
public class UnTestMediumController extends BaseObjectController<UnTestMedium> {

	@Autowired
	public UnTestMediumController(UnTestMediumService mediumService, MessageService messageService, LanguageService languageService) {
		super(mediumService, messageService, languageService, UnTestMedium.class);
	}

    @PreAuthorize("hasRole('ROLE_WRITER') or hasRole('ROLE_ADMIN')")
    @RequestMapping(value = "/add", method = RequestMethod.GET)
    public String add(UnTestMedium untestmedium, Model model) {
        model.addAttribute("untestmedium", untestmedium);
        return super.addView(untestmedium);
    }

    @PreAuthorize("hasRole('ROLE_WRITER') or hasRole('ROLE_ADMIN')")
    @RequestMapping(value = "/add", method = RequestMethod.POST)
    public String add(@Valid final UnTestMedium untestmedium,
                      BindingResult result,
                      final RedirectAttributes redirectAttributes) throws InternalErrorException {

        return super.add(untestmedium, result, redirectAttributes);
    }
    ...
    public String edit(@Valid final UnTestMedium untestmedium,
                       BindingResult result,
                       final RedirectAttributes redirectAttributes) throws DataNotFoundException, InternalErrorException {

        return super.edit(untestmedium, result, redirectAttributes);
    }
