...
public class GlobalProcessController extends BaseProcessController {

    @Autowired
    public GlobalProcessController(ProcessService processService, MessageService messageService, LanguageService languageService) {
        super(processService, messageService, ProcessType.GLOBAL_PROCESS, languageService);
    }
